...
for(obs in 1:nrow(chop_datasheet)){
  ...
  for(side in c("R","L")){
    ...
    sag_file = paste0(chop_img_root_dir,"/",img_id_num,"_SAG_",side,"_cropped.png")
    trans_file = paste0(chop_img_root_dir,"/",img_id_num,"_TRAN_",side,"_cropped.png")
