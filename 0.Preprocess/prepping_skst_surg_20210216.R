...
for(id in unique(stan_dat$anon_mrn)){
  ...
  for(acc in df_sub$anon_accession){
    if(dir.exists(paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-",acc))){
      ...
      if(file.exists(paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/LS.jpg")) &
         file.exists(paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/LT.jpg"))){
        st_sk_list[[id]][["Left"]][[acc]][["sag"]] = paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/LS.jpg")
        st_sk_list[[id]][["Left"]][[acc]][["trv"]] = paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/LT.jpg")
      ...
      if(file.exists(paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/RS.jpg")) &
         file.exists(paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/RT.jpg"))){
        st_sk_list[[id]][["Right"]][[acc]][["sag"]] = paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/RS.jpg")
        st_sk_list[[id]][["Right"]][[acc]][["trv"]] = paste0("C:/Users/lauren erdman/OneDrive - SickKids/HN/Stanford/RLST_labeled_imgs/batch_dicom_",id,"-", acc, "/RT.jpg")
...
write(toJSON(stan_only_list), "C:/Users/lauren erdman/Desktop/kidney_img/HN/SickKids/preprocessed_images_StanOnly_filenames_20210413.json")
