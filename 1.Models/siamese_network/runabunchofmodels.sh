...
var1="/storage/20190703_CVModels/"
var3="/storage/20190703_fullModels/"

mkdir $var1
mkdir $var3


dir_name="20190703_vanilla_siamese_hydroonly4realz_fullModelPretraining"
python3 train_siamese_network_CV_v2.py --hydro_only --unet --sc 0 --init "none" --contrast 2 --batch_size 128 --epochs 35 --view 'siamese' --output_dim 256 --dir "$var1$dir_name" --checkpoint /storage/20190619_fullModels/20190619_vanilla_siamese_eval_dropout1_0.5_full/checkpoint_21.pth > "$dir_name$var2" && mv "$dir_name$var2" "$var1$dir_name"
