...
# SiameseNetworkUNet = importlib.machinery.SourceFileLoader('SiameseNetworkUNet','/Users/Marta/nephronetwork'
#                                                                    '/1.Models/siamese_network/SiameseNetworkUNet.py').load_module()
# SiamNet = SiameseNetworkUNet.SiamNet
