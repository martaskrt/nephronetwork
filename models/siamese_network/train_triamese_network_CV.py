...
def main():
    ...
    parser.add_argument('--train_dir', default='/home/lauren/train-us-seqs', type=int, help="Number of epochs")
    ...
    train_X,train_y,test_X,test_y = get_training_test_data(args)
...
# args = options()
# 
# args.train_dir = 'C:/Users/larun/Desktop/Data Science Core/Projects/Urology/Image-analysis/triad/training-dir'
# args.epochs = 4
# args.batch_size = 32
# args.lr = 0.001
# args.momentum = 0.9
