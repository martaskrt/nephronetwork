...
## ORIGINALLY FROM VisionLearningGroup.github.io
class Solver(object):
    def __init__(self, args, interval=100, optimizer='adam',
    ...
    def train(self, epoch, record_file=None):
        ...
        for batch_idx, data in enumerate(self.datasets):
            ...
            #     ## find way to print loss from each source more easily
            #     print(
            #         'Train Epoch: {} [{}/{} ({:.0f}%)] Discrepancy: {:.6f}'.format(
            #             epoch, batch_idx, 100,
            #             100. * batch_idx / 70000, loss_msda.data[0]))
            #     if record_file:
...
def main():
    ...
    parser.add_argument('-target', default="Stanford", help="US machine (data source) held out of training")
    ...
    parser.add_argument('-datasheet', default='C:/Users/lauren erdman/Desktop/kidney_img/View_Labeling/datasheets/kidney_view_sda_sksub_stsub_20201129.csv',
    ...
    parser.add_argument("-optimizer", default='momentum', help="Momentum")
