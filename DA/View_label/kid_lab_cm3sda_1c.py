...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        x = conv_out.view(conv_out.size(0), 4096)
...
class GradCam():
    ...
    def __init__(self, G, C1):
        ...
        # Define extractor
        self.extractor = CamExtractor(self.G, self.C1)
...
class PairedData(object):
    def __init__(self, data_loader_s, data_loader_t, max_dataset_size):
        ...
        ## why is data_loader_t not a dictionary?
...
def main():
    ...
    parser.add_argument('-datasheet',
                        default='C:/Users/lauren erdman/Desktop/kidney_img/View_Labeling/datasheets/kidney_view_n500_sda_stsub_machine_spec_20210102.csv',
